...
public fun check_nft(user_address: address, user_nft_table: &mut UserNFTTable) {
    let mut i = 0;
...
public fun check_pool(typename: TypeName, pooltable: &mut PoolTable) {
    let mut i = 0;
...
public fun add_poolinfo(pool_id: ID, typename: TypeName, pooltable: &mut PoolTable) {
...
public fun check_scam(typename: TypeName, scampool: &mut ScamCoinPool) {
    let mut i = 0;
...
public fun check_mark_scam(typename: TypeName, scampool: &mut ScamCoinPool, ctx: &mut TxContext) {
    let mut i = 0;
